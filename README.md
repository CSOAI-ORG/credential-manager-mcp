...
[![PyPI](https://img.shields.io/badge/PyPI-Install-3775a9)](https://pypi.org/project/credential_manager_mcp/)

> Verifiable credential management

Verifiable credential management. Issue, verify, revoke, and audit credentials with cryptographic integrity. By MEOK AI Labs.
...
```bash
# Install via pip
pip install credential_manager_mcp

# Or install via Smithery
npx -y @smithery/cli@latest install credential-manager-mcp --client claude
```
...
- [Full Documentation](https://docs.meok.ai/credential-manager-mcp)
...
Or: `pip install credential-manager-mcp` then run the `credential-manager-mcp` command (stdio transport).
